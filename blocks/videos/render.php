<?php
/**
 * Server render for the moment/videos dynamic block.
 *
 * Delegates to the shared Moment_Renderer so the block and the
 * [moment_videos] shortcode produce identical markup.
 *
 * @package Moment
 *
...
echo Moment_Plugin::instance()->renderer->render( 'videos', array( 'count' => $moment_view_count ) );
