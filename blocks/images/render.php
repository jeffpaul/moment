<?php
/**
 * Server render for the moment/images dynamic block.
 *
 * Delegates to the shared Moment_Renderer so the block and the
 * [moment_images] shortcode produce identical markup.
 *
 * @package Moment
 *
...
echo Moment_Plugin::instance()->renderer->render( 'images', array( 'count' => $moment_view_count ) );
